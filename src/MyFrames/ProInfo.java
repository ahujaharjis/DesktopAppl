...
public ArrayList<Product> List(String ValToSearch)
    {
        ...
        try{
            ...
            st=con.createStatement();
             String query="SELECT * FROM `stock` WHERE CONCAT(`id`,`pname`,`available`,`mrp`, `gst`, `hsn`, `per`) LIKE '%"+ValToSearch+"%';";
             //
            ...
            {
               product = new Product(
                                rs.getString("id"), rs.getString("pname"),rs.getInt("available"),rs.getFloat("mrp"),rs.getInt("gst"),rs.getInt("hsn"),rs.getString("per")
               ); 
               pro.add(product);
            }
    ...
    public void findproduct()
        {
            ...
            model.setColumnIdentifiers(new Object[]{"Product Id","Product Name","Available","GST%","Mrp","HSN","Per"});
            ...
            for(int i=0;i < prod.size(); i++)
            {
                ...
                row[3] = prod.get(i).getgst();
                row[4] = prod.get(i).getmrp();
                row[5] = prod.get(i).gethsn();
                row[6] = prod.get(i).getper();
                model.addRow(row);
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Name", "Available", "GST%", "Mrp", "HSN", "PER"
            }
        ));
