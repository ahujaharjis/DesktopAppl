...
public class SearchBill extends javax.swing.JInternalFrame {
    ...
    public ArrayList<BillSearch> List(String ValToSearch,String res)
    {
        ...
        try{
            ...
            if(res=="bno")
              query="SELECT * FROM `bill` WHERE `bno`="+jTextField1.getText()+";";
            else if(res=="cname")
                query="SELECT * FROM `bill` WHERE `cname`='"+jTextField1.getText()+"';";
            else
                query="SELECT * FROM `bill` WHERE `pdate`='"+jTextField1.getText()+"';";
        ...
        public void findbill(String res)
        {
            ArrayList <BillSearch> bills = List(jTextField1.getText(),res);
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Bill", "Customer Name", "Date" }));
...
//search button
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     if(Name=="Bill")
        ...
        findbill("pdate");// TODO add your handling code here:
