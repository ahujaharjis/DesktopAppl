...
public class AddCash extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Name", "Mno.", "Address", "Street", "City", "Email", "GST-pin no"
            }
        ));
    ...
    String query="INSERT INTO `customer`(`cust_name`,`cust_no`,`cust_address`,`cust_email`,`gst_pin`,`cust_street`,`cust_city`) VALUES('"+jTextField2.getText()+"','"+jTextField3.getText()+"','"+jTextField7.getText()+"','"+jTextField5.getText()+"','"+jTextField6.getText()+"','"+jTextField4.getText()+"','"+jTextField8.getText()+"');";
    executeSQlQuery(query, "Inserted");
    }//GEN-LAST:event_anewActionPerformed

    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
    String query="UPDATE `customer` SET `cust_name`='"+jTextField2.getText()+"',`cust_no`='"+jTextField3.getText()+"',`cust_address`='"+jTextField7.getText()+"',`cust_email`='"+jTextField5.getText()+"',`gst_pin`='"+jTextField6.getText()+"',`cust_street`='"+jTextField4.getText()+"',`cust_city`='"+jTextField8.getText()+"' WHERE `cust_id`="+jTextField1.getText();
    ...
    public ArrayList<Cash>getCashList()
    {
        ...
        try{
            ...
            while(rs.next())
            {
                cash = new Cash(rs.getInt("cust_id"),rs.getString("cust_name"),rs.getString("cust_no"),rs.getString("cust_address"),rs.getString("cust_street"),rs.getString("cust_city"),rs.getString("cust_email"),rs.getString("gst_pin"));
               cashList.add(cash);
            }
